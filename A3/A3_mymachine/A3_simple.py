...
if not os.path.exists('A3_simple'):
    os.makedirs('A3_simple')

i = 0
while os.path.isfile('A3_simple/' + dataset + '_log_' + str(i) + '.csv'):
    i += 1
test_id = i
test_id = str(test_id)

twitter_logger = CSVLogger(filename='A3_simple/' + dataset + '_log_' + test_id + '.csv', fieldnames=['epochs', 'train_cost', 'val_cost', 'best_cost'])
